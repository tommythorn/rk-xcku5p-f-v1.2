...
namespace eval ::optrace {
  variable script "D:/VIVADO23/ku5p/07uart_eco/07uart_eco.runs/impl_1/uart_eco.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/VIVADO23/ku5p/07uart_eco/07uart_eco.runs/synth_1/uart_eco.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc D:/VIVADO23/ku5p/07uart_eco/07uart_eco.srcs/constrs_1/new/uart_eco.xdc
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top uart_eco -part xcku5p-ffvb676-2-i 
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi uart_eco.mmi }
