...
HD_PWD='D:/VIVADO23/ku5p/07uart_eco/07uart_eco.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_eco.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_eco.tcl -notrace
