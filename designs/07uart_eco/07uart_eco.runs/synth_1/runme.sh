...
HD_PWD='D:/VIVADO23/ku5p/07uart_eco/07uart_eco.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_eco.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_eco.tcl
