...
HD_PWD='D:/VIVADO231/ku5p/ref/top_sd_rw ku5p/prj/top_sd_rw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sd_rw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_sd_rw.tcl
