...
HD_PWD='D:/VIVADO231/ku5p/ref/top_sd_rw ku5p/prj/top_sd_rw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sd_rw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_sd_rw.tcl -notrace
