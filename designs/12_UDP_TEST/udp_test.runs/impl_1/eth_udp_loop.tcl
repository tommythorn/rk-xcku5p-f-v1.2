...
namespace eval ::optrace {
  variable script "D:/VIVADO23/ku5p/12_UDP_TEST/udp_test.runs/impl_1/eth_udp_loop.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/VIVADO23/ku5p/12_UDP_TEST/udp_test.runs/synth_1/eth_udp_loop.dcp
...
OPTRACE "link_design" START { }
  link_design -top eth_udp_loop -part xcku5p-ffvb676-2-i 
